...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'discover' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'discover' ),
		'repeat-y'  => __( 'Repeat Vertically', 'discover' ),
		'repeat'    => __( 'Repeat All', 'discover' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'discover' ),
		'top center'    => __( 'Top Center', 'discover' ),
		'top right'     => __( 'Top Right', 'discover' ),
		'center left'   => __( 'Middle Left', 'discover' ),
		'center center' => __( 'Middle Center', 'discover' ),
		'center right'  => __( 'Middle Right', 'discover' ),
		'bottom left'   => __( 'Bottom Left', 'discover' ),
		'bottom center' => __( 'Bottom Center', 'discover' ),
		'bottom right'  => __( 'Bottom Right', 'discover')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'discover' ),
		'fixed'  => __( 'Fixed in Place', 'discover')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'discover' ),
		'italic'      => __( 'Italic', 'discover' ),
		'bold'        => __( 'Bold', 'discover' ),
		'bold italic' => __( 'Bold Italic', 'discover' )
		);
